package hk.htw.ao.control.sort;
...
public class InsertionSortController extends FunctionController {


	public InsertionSortController() {
		super();
		this.title = "Insertion Sort";
		this.description = "Insertion Sort, itertiv";
	...
	public void startRun() {
		...
		InsertionSort function = new InsertionSort(parameterValues);
